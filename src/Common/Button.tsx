...
const Button: React.FC<ButtonProps> = ({ disabled, label, textColor, buttonHeight, BackColor, BorderColor, BW, onClick, isLoading, none, width="w-[100%] ", font="font-semibold" }) => {
...
<p className={`text-[14px] ${font} leading-[19.5px] text-center text-[#FFFFFF]`}   style={{ color: textColor || 'white' }} >{label}</p>
        </button>
    );
}
