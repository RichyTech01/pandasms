    ...
    return (
        <aside className="w-[226px] bg-[#116EFC] pt-[39px] px-[17px] hidden md:flex h-full">
          <ul>
            ...
            <li className={`my-[20px] py-[16px] px-[22px] rounded-[8px] fc ${pathname === "/Verification" ? "font-semibold text-[14px] text-[#0F64E5] bg-white " : "text-white font-normal "} cursor-pointer`}>
            ...
            <li className={`py-[16px] px-[22px] rounded-[8px] fc ${pathname === "/History" ? "font-semibold text-[14px] text-[#0F64E5] bg-white " : "text-white font-normal "} cursor-pointer`}>
            ...
            <li className={`my-[20px]  py-[16px] px-[22px] rounded-[8px] fc ${pathname === "/Account" ? "font-semibold text-[14px] text-[#0F64E5] bg-white " : "text-white font-normal "} cursor-pointer`}>
